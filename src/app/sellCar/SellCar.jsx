              ...
              <div className="tab-content" id="myTabContent">
                ...
                >
                  ...
                  <p>
                    ...
                    día. El mejor BMW M4 con homologación para circular por la
                    vía pública de todos los tiempos Reducción del peso de hasta
                    100 kg en comparación con el BMW M4 Competition Coupé Motor
                    de gasolina de 6 cilindros en línea BMW M TwinPower Turbo de
                    405 kW (551 CV) de elevadas prestaciones Neumáticos Ultra
                    Track específicos para el vehículo Diseño exclusivo
                  </p>
                </div>
                <div
              ...
              <div className="tab-content" id="myTabContent">
                ...
                >
                  ...
                  <p>
                    ...
                    al otro lado del horizonte. Todo se suma a que Corvette es
                    la placa de identificación de automóvil de pasajeros
                    producida continuamente más larga en historia mundial. Hoy
                    lo celebramos con la magnífica Edición 70 Aniversario, así
                    como con la primer Corvette Z06 con motor central, que
                    anuncia un nuevo nivel de desempeño similar al de un auto de
                    carreras combinado con una comodidad sorprendente.
                  </p>
                </div>
                <div
                  className="tab-pane fade mt4"
              ...
              <div className="tab-content" id="myTabContent">
                ...
                >
                  ...
                  <p>
                    ...
                    renombrados del mundo. Sin embargo, también es un Bentley, y
                    eso significa el rendimiento de Bentley. La tecnología
                    avanzada del motor ofrece una aceleración sin esfuerzo y
                    velocidades máximas increíbles para un automóvil tan cómodo
                    y lujoso. Mientras tanto, los sistemas de chasis controlados
                    por computadora hacen que la conducción dinámica sea más
                    segura, fácil y emocionante. Un verdadero buque insignia de
                    lujo, el Continental GT Mulliner es todo lo que debe ser un
                    gran turismo, y más.
                  </p>
                </div>
                <div
              ...
              <div className="tab-content" id="myTabContent">
                ...
                >
                  ...
                  <p>
                    ...
                    cilindros con lubricación por cárter seco. La cilindrada del
                    motor aspirado V10 de 5,5 litros, concebido para competir,
                    se aumentó a 5,7 litros para la serie.Con una potencia de
                    450 kW/612 CV a 8.000 rpm y una velocidad máxima superior a
                    los 330 km/h, el Carrera GT marcó nuevas pautas. Las fuerzas
                    de tracción se tomaron de una caja de cambios manual de 6
                    velocidades.
                  </p>
                </div>
                <div
              ...
              <div className="tab-content" id="myTabContent">
                ...
                >
                  ...
                  <p>
                    ...
                    McLaren M838T 3.8L motor V8 de doble turbo, que genera 600
                    PS (592 hp), que luego se incrementó a 625 PS (616 hp) en
                    2012, y todo el vehículo utiliza fibra de carbono para
                    reducir el peso a un peso en vacío de 1434 kg (3161 lb) .
                    También utiliza un diseño convencional de 2 plazas en
                    comparación con el diseño irregular de 3 asientos de la F1
                    (1 en el centro, dos detrás a cada lado).
                  </p>
                </div>
                <div
                  className="tab-pane fade mt4"
              ...
              <div className="tab-content" id="myTabContent">
                ...
                >
                  ...
                  <p>
                    ...
                    transigir en nada. En un futuro gobernado por la tecnología
                    se están perdiendo las emociones reales, pero en el futuro
                    que estamos diseñando están siempre en primer plano, porque
                    siempre es el ser humano quien conduce. <br /> A la
                    impecable dinámica del vehículo y a las prestaciones del
                    nuevo motor aspirado se suma la excelencia del diseño, donde
                    materiales de alta gama y exclusivos entran en simbiosis con
